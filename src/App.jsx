  ...
  return (
    <div className="min-h-screen bg-white">
        ...
        <div className="max-w-4xl mx-auto px-4 text-center">
          <div className="inline-block">
            <div className="w-80 h-80 mx-auto mb-8 border-4 border-black overflow-hidden bg-gray-100">
              <img 
                src="/src/assets/images/rs=w_365,h_365,cg_true.webp" 
                alt="Marci J Metzger" 
        ...
        <div className="max-w-7xl mx-auto px-4">
          ...
          <div className="space-y-8">
            {[
              { 
                id: 1, 
                image: '/src/assets/images/f1.webp',
              ...
              { 
                id: 2, 
                image: '/src/assets/images/f2.webp',
              ...
              { 
                id: 3, 
                image: '/src/assets/images/f3.webp',
      ...
      <section className="py-20 bg-white relative">
        <div className="absolute inset-0">
          <img 
            src="/src/assets/images/find_section.jpg" 
      ...
      <section className="py-20 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
            {[
              '/src/assets/images/l1.webp',
              '/src/assets/images/l2.webp',
              '/src/assets/images/l3.webp',
              '/src/assets/images/l4.webp'
            ].map((logo, index) => (
      ...
      <section className="py-20 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              {
                image: '/src/assets/images/S1.webp',
              ...
              {
                image: '/src/assets/images/S2.webp',
              ...
              {
                image: '/src/assets/images/S3.webp',
